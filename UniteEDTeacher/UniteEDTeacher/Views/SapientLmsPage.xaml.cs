...
namespace UniteEDTeacher.Views
{
    ...
    /// </summary>
    public sealed partial class SapientLmsPage : UniteEDTeacher.Common.LayoutAwarePage
    {
        ApplicationDataContainer settings;

        public SapientLmsPage()
        {
            this.InitializeComponent();
            settings = Windows.Storage.ApplicationData.Current.LocalSettings;

            string url = "http://sapienteducation.blogspot.com/2014/09/what-is-sapient-lms.html";
            WebviewSapientLms.Navigate(new Uri(url));

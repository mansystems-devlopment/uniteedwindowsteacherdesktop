...
namespace UniteEDTeacher.Views
{
    ...
    /// </summary>
    public sealed partial class RssCloudbancPage : UniteEDTeacher.Common.LayoutAwarePage
    {
        ApplicationDataContainer settings;

        public RssCloudbancPage()
        {
            this.InitializeComponent();
            settings = Windows.Storage.ApplicationData.Current.LocalSettings;

            string url = "http://sapienteducation.blogspot.com/2014/09/how-to-use-cloudbanc.html";
            WebviewRsCloud.Navigate(new Uri(url));
        }
        ...
        //            if (moduleSetting.SettingName.Equals("moodleMediaUrl"))
        //            {
        //                moodleMediaUrl = moduleSetting.SettingData;
        //            }
        ...
        //                            WebviewMedia.NavigateToString(cleanstr);
        //                        });

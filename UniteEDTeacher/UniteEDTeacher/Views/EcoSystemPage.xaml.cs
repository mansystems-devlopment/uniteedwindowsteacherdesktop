...
namespace UniteEDTeacher.Views
{
    ...
    /// </summary>
    public sealed partial class EcoSystemPage : UniteEDTeacher.Common.LayoutAwarePage
    {
        ...
        public EcoSystemPage()
        {
            ...
            string url = "https://www.youtube.com/watch?v=2GcmI8Vego0";
            WebviewEcoSystem.Navigate(new Uri(url));
        }

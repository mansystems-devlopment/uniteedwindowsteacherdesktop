...
namespace UniteEDTeacher.Views
{
    ...
    /// </summary>
    public sealed partial class MySportPage : UniteEDTeacher.Common.LayoutAwarePage
    {
        ...
        public MySportPage()
        {
            ...
            //string url = " xshttp://theridgetuckshop.co.za/index.php";
                    ...
                    try
                    {
                        using (System.IO.StreamReader httpwebStreamReader = new StreamReader(httpResponse.GetResponseStream()))
                        {
                            ...
                            Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () =>
                            {
                                ...
                                WebviewMyCourses.Navigate(new Uri(sportUrl));
                            });
